class RegistrationsController < ApplicationController
  ...
  def create
    ...
    @registration.job = @event.jobs.find( params[:registration][:job_id] )
  ...
  def registration_params
    params.require(:registration).permit(:ticket_id, :name, :email, :cellphone, :department_id, :job_id, :description)
  end
